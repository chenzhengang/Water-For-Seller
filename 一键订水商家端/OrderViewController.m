...
- (void)viewDidLoad {
    ...
    nameLabel.text = [NSString stringWithFormat:@"%@",array[0]];
    [commodityLabel setText:@"商品名："];
    commodityLabel.text = [NSString stringWithFormat:@"%@",array[1]];
    [addressLabel setText:@"地址："];
    addressLabel.text = [NSString stringWithFormat:@"%@",array[2]];
    [phoneLabel setText:@"联系电话："];
    phoneLabel.text = [NSString stringWithFormat:@"%@",array[3]];
...
//        make.centerY.equalTo(weakSelf.view).with.offset(2);
    ...
    [sendButton mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.equalTo(addressLabel.mas_bottom).with.offset(100);
    }];
}
